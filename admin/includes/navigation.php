...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                <a href="../index.php"><i class="fa fa-fw fa-bar-chart-o"></i> Site View</a>
            </li>
            ...
            <li>
                <a href="all_comments.php"><i class="fa fa-fw fa-comment"></i>Comments</a>
            </li>
            <li>
            ...
            <li>
                <a href="all_users.php"><i class="fa fa-fw fa-user"></i> All Users</a>
            </li>

            <li>
                <a href="add_users.php"><i class="fa fa-fw fa-user"></i> Add Users</a>
            </li>
        </ul>
    </div>
    <!-- /.navbar-collapse -->
